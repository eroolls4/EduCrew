    ...
    public class ManageController : Controller
    {
        ...
        public async Task<ActionResult> Index(ManageMessageId? message)
        {
            ...
            var model = new IndexViewModel
            {
                ...
                Description = UserManager.FindById(userId).Description,
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<ActionResult> SetBio(SetBioViewModel model)
        {
            if (!ModelState.IsValid)
            {
                return View(model);
            ...
            if (user != null)
            {
                ...
                {
                    await SignInManager.SignInAsync(user, isPersistent: false, rememberBrowser: false);
                    return RedirectToAction("Index");  //, new { Message = ManageMessageId.SetBioSuccess });
                }
                AddErrors(result);
            }
            return View(model);
        ...
        // GET: /Manage/SetProfileImage
        public ActionResult SetProfileImage()
        {
            return View();
        }

        // POST: /Manage/SetProfileImage
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<ActionResult> SetProfileImage(SetProfileImageViewModel model)
        {
            if (!ModelState.IsValid)
            {
                return View(model);
